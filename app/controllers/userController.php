...
class userController extends mainModel
{
    ...
    public function registrarUsuarioControlador()
    {
        ...
        if ($check_usuario->rowCount() > 0) {
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrio un error inesperado",
                "texto" => "El usuario ya ha sido registrado",
                "icono" => "error"
            ];
            return json_encode($alerta);
            exit();
        ...
        if ($registrar_usuario->rowCount() == 1) {
            ...
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrio un error inesperado",
                "texto" => "El usuario no pudo ser registrado",
                "icono" => "error"
            ];
        }
        return json_encode($alerta);
    ...
    public function actualizarUsuarioControlador()
    {
        ...
        if ($datos->rowCount() <= 0) {
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrio un error inesperado",
                "texto" => "El usuario no ha sido encontrado en el sistema",
                "icono" => "error"
            ];
            return json_encode($alerta);
            exit();
        ...
        if ($admin_usuario == "" || $admin_clave == "") {
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrio un error inesperado",
                "texto" => "No se han completado los campos de usuario y clave",
                "icono" => "error"
            ];
            return json_encode($alerta);
            exit();
    ...
    # Controlador para actualizar foto de usuario #
    ...
    # Controlador para eliminar la foto del usuario #
        ...
        if (is_file($img_dir . $datos['usuario_foto'])) {
            ...
            if (!unlink($img_dir . $datos['usuario_foto'])) {
                $alerta = [
                    "tipo" => "simple",
                    "titulo" => "Ocurrió un error inesperado",
                    "texto" => "No se ha podido eliminar la foto del usuario",
                    "icono" => "error"
                ];
                return json_encode($alerta);
                exit();
            ...
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrió un error inesperado",
                "texto" => "No hemos encontrado la imagen del usuario en el sistema",
                "icono" => "error"
            ];
            return json_encode($alerta);
            exit();
    ...
    public function eliminarUsuarioControlador()
    {
        ...
        if ($id == 1) {
            $alerta = [
                "tipo" => "simple",
                "titulo" => "Ocurrio un error inesperado",
                "texto" => "No podemos eliminar el usuario principal en el sistema",
                "icono" => "error"
            ];
            return json_encode($alerta);
            exit();
        ...
        $eliminarUsuario = $this->eliminarRegistros("USUARIO", "usuario_id", $id);
